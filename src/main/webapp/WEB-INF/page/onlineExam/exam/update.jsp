        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <div class="col-xs-4">
                        <select class="form-control select2-hidden-accessible subid" required name=""
                                disabled="disabled">
                            <c:forEach items="${sList}" var="sList">
                                <c:if test="${sList.subid==exam.subid}">
                                    <option value="${sList.subid}" selected>${sList.subname}</option>
                                </c:if>
                                <c:if test="${sList.subid==exam.subid}">
                                    <option value="${sList.subid}" selected>${sList.subname}</option>
                                </c:if>
                ...
                <form id="role-form">
                    <div class="select-list">
                        <ul>
                            ...
                            <li>
                                <a class="btn btn-primary btn-rounded btn-sm" onclick="$.table.search('role-form')"><i
